...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonEqual.setOnClickListener(view -> {
            allCalculations();
            // Update the output display to show the full operation
            String operation = outputDisplay.getText().toString();
            operation += decimalFormat.format(secondValue) + " = " + decimalFormat.format(firstValue);
